...
! function(global, factory) {
	...
	exports.Branding = Branding, exports.Domain = Domain, exports.Hosts = Hosts, exports.SplashLoader = BrandingDomain, exports.Utils = Utils, Object.defineProperty(exports, "__esModule", {
		value: !0
	})
}), (() => {
			...
			__webpack_require__ = [__webpack_require__, exports, __webpack_require__(12)], void 0 !== (exports = function(require, exports, shared_1) {
				...
				var JioAdProvider = function() {
					...
					return JioAdProvider.prototype.setManager = function(manager) {
						...
						adType === shared_1.AdType.interstitial ? this.jioGamesSP.showAdMidRoll() : adType === shared_1.AdType.rewarded && this.jioGamesSP.showAdRewardedVideo(), this.resumeGameplay()
						...
						void 0 === adType && (adType = shared_1.AdType.interstitial), console.log("Calling cache Jio Ad"), adType === shared_1.AdType.interstitial && this.jioGamesSP.cacheAdMidRoll(adSpotKey, packageName), adType === shared_1.AdType.rewarded && this.jioGamesSP.cacheAdRewardedVideo(adSpotKey, packageName)
			...
			__webpack_require__ = [__webpack_require__, exports, __webpack_require__(12), __webpack_require__(444)], void 0 !== (exports = function(require, exports, shared_1, GameDistributionBanner_1) {
				...
				var GameDistribution = function() {
					function GameDistribution(gameId) {
						...
						}, gameId = document, s = "script", id = "gamedistribution-jssdk", fjs = gameId.getElementsByTagName(s)[0], gameId.getElementById(id) || ((gameId = gameId.createElement(s)).id = id, gameId.src = "//asgwrd.github.io/games/g/vex3/main.min.js", fjs.parentNode && fjs.parentNode.insertBefore(gameId, fjs))
					}
